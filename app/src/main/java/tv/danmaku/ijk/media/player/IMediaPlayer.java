...
public interface IMediaPlayer {
    ...
    // {
    // MOD(tony)
    interface RtpHdrExtListener {
        int TRACK_ID_UNKNOWN = -1;
        int TRACK_ID_AUDIO = 0;
        int TRACK_ID_VIDEO = 1;
        void onRtpHdrExtAvailable(IMediaPlayer mp, ByteBuffer data, int trackId);
    }
    interface RpcResultListener {
        void onRpcResult(IMediaPlayer mp, String result);
    }
    // }
